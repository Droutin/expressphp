...
class Router
{
     ...
     *
     * @param string $method One of HTTP Method, or a pipe-separated list of HTTP Methods (GET|POST|PATCH|PUT|DELETE)
     * @param string $route The route regex, custom regex must start with an @. [i:id]
